...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="bagout.php?action=list">Bag It</a></li>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
           ...
           echo'     <span class="badge badge-secondary badge-pill">';
    ...
    foreach ($_SESSION as $name => $value) {
        if ($value > 0) {
            ...
            echo'<li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        ...
                        <small class="text-muted"> Size:' . $row["productSize"] . ' Colour:' . $row["productColour"] . '</small>
                    </div>
                    <span class="text-muted"> $'. ($_SESSION["product_".$id] * $row["price"]) .'</span>
                </li>';
                    }
                }
            }
       ...
       echo' <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" method="post" action="includes/checkOut.inc.php" novalidate>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="zip" placeholder="" value="'.$zip.'" required>
                        <div class="invalid-feedback">
                            Zip code required.
                        </div>
                    </div>
